<%@ Page Title="" Language="C#" MasterPageFile="~/Giao-dien1.Master" AutoEventWireup="true" CodeBehind="datmon.aspx.cs" Inherits="quan_ly_cafe.datmon" %>
    ...
    <form id="form1" runat="server">
        ...
        <table >
            ...
            <tr>
                ...
                <td style="width: 14px"></td>
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="PHIEU TAM TINH" />
                </td>
            </tr>
            <tr>
...
&nbsp;<asp:Label ID="Label7" runat="server" Text="Đơn giá "></asp:Label>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="btnxacnhan" runat="server" Height="33px" OnClick="btnxacnhan_Click" Text="Xác nhận" />
                </td>
            </tr>
        </table>
