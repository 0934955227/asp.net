<%@ Page Title="" Language="C#" MasterPageFile="~/GDthungan.Master" AutoEventWireup="true" CodeBehind="datmontn.aspx.cs" Inherits="quan_ly_cafe.datmontn" %>
    ...
    <form id="form1" runat="server">
        ...
        <table >
            ...
            <tr>
                ...
                <td style="width: 14px"></td>
                <td>
                    <asp:Button ID="btntt" runat="server"  Text="PHIEU TAM TINH" OnClick="btntt_Click" />
                </td>
            </tr>
            <tr>
