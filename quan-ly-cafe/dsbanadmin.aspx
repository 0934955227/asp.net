        ...
        <table >
            ...
            <tr>
                <td style="text-align:left">
                    ...
                    <asp:Button ID="btnkva" runat="server" style="margin-left: 18px" Text=" A" Width="90" Height="45" BackColor="#00ccff" ></asp:Button>
            ...
            <tr>
                <td >
                    ...
                    <asp:Panel ID="pnkhuc" Width="700" runat="server">
                    ...
                    <asp:Panel ID="pnchuyenban" Width="700" runat="server">
                        ...
                        <asp:Button ID="btnthchuyenban" runat="server" Text="OK" OnClick="btnthchuyenban_Click" />
                    ...
                    <asp:Panel ID="pnghepban" Width="700" runat="server">
                        ...
                        <asp:Button ID="btnthghepban" runat="server" OnClick="btnthghepban_Click" Text="chọn" />
                     ...
                     <asp:Panel ID="pntachban" runat="server">
                            ...
                            <br />
                            <asp:Button ID="btnthchonban" runat="server" Text="OK" OnClick="btnthchonban_Click" />                           
                        </asp:Panel>
                        <asp:Panel ID="pnhoadon" Width="700" runat="server">
                            ...
                            <br />
                            <asp:Button ID="btnthtach" runat="server" OnClick="btnthtach_Click" Text="Tách" />
                            <br />
                ...
                <td>
                    <asp:Button ID="btnchuyenban" runat="server" OnClick="btnchuyenban_Click" Text="Chuyển bàn" />
                    <br />
