<%@ Page Title="" Language="C#" MasterPageFile="~/GDadmin.Master" AutoEventWireup="true" CodeBehind="phieutamtinhadmin.aspx.cs" Inherits="quan_ly_cafe.phieutamtinhadmin" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                ...
                <br />
                <asp:Button ID="btntt" runat="server" Text="Yêu cầu thanh toán" OnClick="btntt_Click" Width="135px"  />
                <asp:Button ID="Button1" runat="server" Text="In hóa đơn" />
