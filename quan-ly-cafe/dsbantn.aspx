<%@ Page Title="" Language="C#" MasterPageFile="~/GDthungan.Master" AutoEventWireup="true" CodeBehind="dsbantn.aspx.cs" Inherits="quan_ly_cafe.dsbantn" %>
                ...
                <td >
                    ...
                    <asp:Panel ID="pnghepban" Width="700" runat="server">
                     ...
                     <asp:Panel ID="pntachban" runat="server">
                            ...
                            <br />
                            <asp:Button ID="btnthchonban" runat="server" Text="Chọn" OnClick="btnthchonban_Click" Width="61px" />                           
                        </asp:Panel>
                        <asp:Panel ID="pnhoadon" Width="700" runat="server">
                            ...
                            <asp:TextBox ID="txtsl" runat="server" Width="168px" TextMode="Number"></asp:TextBox>
