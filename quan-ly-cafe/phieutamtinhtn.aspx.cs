...
namespace quan_ly_cafe
{
    public partial class phieutamtinhtn : System.Web.UI.Page
    {
        ...
        protected void btnchebien_Click(object sender, EventArgs e)
        {
            ...
            if(guibep)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Gửi bếp thành công');location.href='/phieutamtinhtn.aspx';", true);
                bool tt = BANDAO.Instance.capnhattrangthaicokhach(maban);
                if(!tt)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Cập nhật không thành công');location.href='/phieutamtinhtn.aspx';", true);
                }
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Thất bại');location.href='/phieutamtinhtn.aspx';", true);
            }
        }
        ...
        protected void btnthemmon_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Bạn phải nhập số lượng > 0');location.href='/phieutamtinhtn.aspx';", true);
                }
                else
                {
        ...
        protected void btnhuymon_Click(object sender, EventArgs e)
        {
            ...
            if(txtsl.Text == "")
            {
                ...
                if(huymon)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Hủy món thành công');location.href='/phieutamtinhtn.aspx';", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Thất bại');location.href='/phieutamtinhtn.aspx';", true);
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Hủy hơn số lượng chưa gửi bếp');location.href='/phieutamtinhtn.aspx';", true);
                }
            }
        }
