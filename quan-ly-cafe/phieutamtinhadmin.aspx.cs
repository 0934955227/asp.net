...
namespace quan_ly_cafe
{
    public partial class phieutamtinhadmin : System.Web.UI.Page
    {
        ...
        protected void btnthemmon_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Thất bại');location.href='/phieutamtinhadmin.aspx';", true);
            }
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Bạn phải nhập số lượng > 0');location.href='/phieutamtinhadmin.aspx';", true);
                }
                else
                {
        ...
        protected void btnhuymon_Click(object sender, EventArgs e)
        {
            ...
            if (txtsl.Text == "")
            {
                ...
                if (huymon)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Hủy món thành công');location.href='/phieutamtinhadmin.aspx';", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Thất bại');location.href='/phieutamtinhadmin.aspx';", true);
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Hủy hơn số lượng chưa gửi bếp');location.href='/phieutamtinhadmin.aspx';", true);
                }
            }
        }
        ...
        protected void btnchebien_Click(object sender, EventArgs e)
        {
            ...
            if (guibep)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Gửi bếp thành công');location.href='/phieutamtinhadmin.aspx';", true);
                bool tt = BANDAO.Instance.capnhattrangthaicokhach(maban);
                if (!tt)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Cập nhật không thành công');location.href='/phieutamtinhadmin.aspx';", true);
                }
            }
            else
            {
        ...
        protected void btntt_Click(object sender, EventArgs e)
        {
            ...
            if(tinhtrangban ==1 )
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Không có món');location.href='/phieutamtinhadmin.aspx';", true);
            }
            else
            {
        ...
        protected void btndsban_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Có món chưa gửi bếp');location.href='/phieutamtinhadmin.aspx';", true);
        ...
        protected void btnthanhtoan_Click(object sender, EventArgs e)
        {
            string user = Session["user"].ToString();
            int maban = BANDAO.Instance.maban(lbtenban.Text);
            bool thanhtoan = HOADONDAO.Instance.capnhatthanhtoan(maban, user);
            if (thanhtoan)
            {
