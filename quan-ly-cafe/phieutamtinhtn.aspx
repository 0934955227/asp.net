    ...
    <table style="width:100%;">
         <tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btndatmon" runat="server" Text="Đặt món mới" />
                </td>
            </tr>
            <tr>
        ...
        <tr>
            <td>
                ...
                <br />
                <asp:Button ID="btnthemmon" runat="server" Text="Thêm món" OnClick="btnthemmon_Click" Width="80px" />
                ...
                <asp:Button ID="btnhoadon" runat="server" Text="In hóa đơn" Width="90px" />
                <asp:Button ID="btntt" runat="server" Text="Thanh toán" OnClick="btntt_Click" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
